...
- [Siliq](https://github.com/Euda1mon1a/siliq) - Verified computation marketplace for AI agents. Constraint solving, FHE encryption, private set intersection, schedule optimization, and more. Pay per call via x402 USDC on Base.
